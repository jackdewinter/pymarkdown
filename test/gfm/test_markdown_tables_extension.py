...
| bar | baz | bam |"""
    expected_tokens = [
        ...
        "[text(1,9):defghi:]",
        "[end-table-header-item: |::False]",
        "[table-header-item(1,18): :left]",
        "[text(1,18):jkl:]",
        "[end-table-header-item: |::False]",
        "[end-table-header:::False]",
        "[table-body(3,1)]",
        "[table-row(3,1):::True:0]",
        "[table-row-item(3,3): :center]",
        "[text(3,3):bar:]",
        "[end-table-row-item: |::False]",
        "[table-row-item(3,9): :right]",
        "[text(3,9):baz:]",
        "[end-table-row-item: |::False]",
        "[table-row-item(3,15): :left]",
        "[text(3,15):bam:]",
        "[end-table-row-item: |::False]",
        "[end-table-row:::False]",
        "[end-table-body:::False]",
...
[baz]: /url"""
    expected_tokens = [
        ...
        "[end-table-row-item: |::False]",
        "[table-row-item(3,9): :]",
        "[link(3,9):shortcut:/url:::::baz:False::::]",
        "[text(3,10):baz:]",
        "[end-link::]",
        "[end-table-row-item: |::False]",
        "[end-table-row:::False]",
...
def test_whitespaces_tables_extension_with_spaces_within_olist() -> None:
   ...
   | baz | bim |"""
    expected_tokens = [
        "[olist(1,1):.:1:3::   \n   ]",
        "[table(1,4)]",
        "[table-header(1,4):::True:| --- | --- |]",
        "[table-header-item(1,6): :]",
        "[text(1,6):foo:]",
        "[end-table-header-item: |::False]",
        "[table-header-item(1,12): :]",
        "[text(1,12):bar:]",
        "[end-table-header-item: |::False]",
        "[end-table-header:::False]",
        "[table-body(3,4)]",
...
"""
    expected_tokens = [
        ...
        "[BLANK(2,2):]",
        "[table(3,4)]",
        "[table-header(3,4): ::True: | --- | --- |]",
        "[table-header-item(3,6): :]",
        "[text(3,6):foo:]",
        "[end-table-header-item: |::False]",
        "[table-header-item(3,12): :]",
        "[text(3,12):bar:]",
        "[end-table-header-item: |::False]",
        "[end-table-header:::False]",
        "[end-table:::False]",
...
"""
    expected_tokens = [
        ...
        "[li(2,1):2::]",
        "[table(2,3)]",
        "[table-header(2,3):::True:| --- | --- |]",
        "[table-header-item(2,5): :]",
        "[text(2,5):foo:]",
        "[end-table-header-item: |::False]",
        "[table-header-item(2,11): :]",
        "[text(2,11):bar:]",
        "[end-table-header-item: |::False]",
        "[end-table-header:::False]",
        "[end-table:::False]",
...
"""
    expected_tokens = [
        ...
        "[table(4,3)]",
        "[table-header(4,3):::True:| --- | --- |]",
        "[table-header-item(4,5): :]",
        "[text(4,5):foo:]",
        "[end-table-header-item: |::False]",
        "[table-header-item(4,11): :]",
        "[text(4,11):bar:]",
        "[end-table-header-item: |::False]",
        "[end-table-header:::False]",
        "[table-body(6,3)]",
...
def test_whitespaces_tables_with_tabs_before_within_unordered_list_and_single_space() -> (
    ...
    """
    Test case:  table preceeded by spaces.
    """
...
def test_whitespaces_tables_with_tabs_before_within_unordered_list_and_spaces() -> None:
    """
    Test case:  table preceeded by spaces and tabs.
    """
...
"""
    expected_tokens = [
        ...
        "[BLANK(3,1):]",
        "[table(4,5)]",
        "[table-header(4,5):\t::True:\t| --- | --- |]",
        "[table-header-item(4,7): :]",
        "[text(4,7):foo:]",
        "[end-table-header-item: |::False]",
        "[table-header-item(4,13): :]",
        "[text(4,13):bar:]",
        "[end-table-header-item: |::False]",
        "[end-table-header:::False]",
        "[table-body(6,5)]",
...
"""
    expected_tokens = [
        ...
        "[BLANK(3,1):]",
        "[table(4,7)]",
        "[table-header(4,7):\t  ::True:\t  | --- | --- |]",
        "[table-header-item(4,9): :]",
        "[text(4,9):foo:]",
        "[end-table-header-item: |::False]",
        "[table-header-item(4,15): :]",
        "[text(4,15):bar:]",
        "[end-table-header-item: |::False]",
        "[end-table-header:::False]",
        "[table-body(6,7)]",
...
"""
    expected_tokens = [
        "[block-quote(1,1)::>\n>\n>]",
        "[table(1,5)]",
        "[table-header(1,5):\t::True:\t| --- | --- |]",
        "[table-header-item(1,7): :]",
        "[text(1,7):foo:]",
        "[end-table-header-item: |::False]",
        "[table-header-item(1,13): :]",
        "[text(1,13):bar:]",
        "[end-table-header-item: |::False]",
        "[end-table-header:::False]",
        "[table-body(3,3)]",
...
def test_whitespaces_tables_with_paragraph_before() -> None:
    """
    Test case:  Tables with paragraph before., note that tables cannot interrupt a paragraph.
...
@pytest.mark.gfm
def test_whitespaces_tables_with_paragraph_before_and_newline() -> None:
    """
