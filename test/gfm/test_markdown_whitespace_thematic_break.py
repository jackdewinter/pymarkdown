...
> def
    * * *"""
    expected_tokens = ['[block-quote(1,1)::> \n> \n]', '[para(1,3):\n\n    ]', '[text(1,3):abc\ndef\n::\n\n]', '[text(3,5):*:]', '[text(3,6): :]', '[text(3,7):*:]', '[text(3,8): :]', '[text(3,9):*:]', '[end-para:::True]', '[end-block-quote:::True]']
...
'[para(2,5):\n    ]', '[text(2,5):def\n::\n]', '[text(3,5):*:]', '[text(3,6): :]', '[text(3,7):*:]', '[text(3,8): :]', '[text(3,9):*:]', '[end-para:::True]', '[end-block-quote:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<p>abc</p>
<blockquote>
<p>def
...
> > def
>   * * *"""
    expected_tokens = ['[block-quote(1,1)::> ]', '[para(1,3):]', '[text(1,3):abc:]', '[end-para:::True]', '[block-quote(2,1)::> > \n> ]', '[para(2,5):]', '[text(2,5):def:]', '[end-para:::False]', '[end-block-quote::> :True]', '[tbreak(3,5):*:  :* * *]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<p>abc</p>
<blockquote>
<p>def</p>
...
def test_whitespaces_thematic_breaks_with_tabs_before_within_unordered_list_and_spaces():
    ...
    source_markdown = """- abc
  \t* * *"""
    expected_tokens = ['[ulist(1,1):-::2::  ]', '[para(1,3):]', '[text(1,3):abc:]', '[end-para:::False]', '[tbreak(2,5):*:\t:* * *]', '[end-ulist:::True]']
    expected_gfm = """<ul>
<li>abc
<hr />
</li>
...
def test_whitespaces_thematic_breaks_with_tabs_before_within_unordered_double_list():
  ...
  - def
\t* * *"""
    expected_tokens = ['[ulist(1,1):-::2:]', '[para(1,3):]', '[text(1,3):abc:]', '[end-para:::True]', '[ulist(2,3):-::4:  :\t]', '[para(2,5):]', '[text(2,5):def:]', '[end-para:::False]', '[tbreak(3,5):*::* * *]', '[end-ulist:::True]', '[end-ulist:::True]']
    expected_gfm = """<ul>
<li>abc
<ul>
<li>def
...
def test_whitespaces_thematic_breaks_with_tabs_before_within_ordered_double_list_x():
   ...
   1. def
\t  * * *"""
    expected_tokens = ['[olist(1,1):.:1:3:]', '[para(1,4):]', '[text(1,4):abc:]', '[end-para:::True]', '[olist(2,4):.:1:6:   :\t  ]', '[para(2,7):]', '[text(2,7):def:]', '[end-para:::False]', '[tbreak(3,7):*::* * *]', '[end-olist:::True]', '[end-olist:::True]']
    expected_gfm = """<ol>
<li>abc
<ol>
<li>def
...
> def
  \t* * *"""
    expected_tokens = ['[block-quote(1,1)::> \n> \n]', '[para(1,3):\n\n  \t]', '[text(1,3):abc\ndef\n::\n\n]', '[text(3,4):*:]', '[text(3,5): :]', '[text(3,6):*:]', '[text(3,7): :]', '[text(3,8):*:]', '[end-para:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<p>abc
def
* * *</p>
...
> > def
 \t* * *"""
    expected_tokens = ['[block-quote(1,1)::> ]', '[para(1,3):]', '[text(1,3):abc:]', '[end-para:::True]', '[block-quote(2,1)::> > \n]',
'[para(2,5):\n \t]', '[text(2,5):def\n::\n]', '[text(3,3):*:]', '[text(3,4): :]', '[text(3,5):*:]', '[text(3,6): :]', '[text(3,7):*:]', '[end-para:::True]', '[end-block-quote:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<p>abc</p>
<blockquote>
<p>def
...
> > def
  \t* * *"""
    expected_tokens = ['[block-quote(1,1)::> ]', '[para(1,3):]', '[text(1,3):abc:]', '[end-para:::True]', '[block-quote(2,1)::> > \n]',
'[para(2,5):\n  \t]', '[text(2,5):def\n::\n]', '[text(3,4):*:]', '[text(3,5): :]', '[text(3,6):*:]', '[text(3,7): :]', '[text(3,8):*:]', '[end-para:::True]', '[end-block-quote:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<p>abc</p>
<blockquote>
<p>def
