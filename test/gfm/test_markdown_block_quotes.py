...
> [foo]"""
    expected_tokens = [
        ...
        "[BLANK(2,2):]",
        "[para(3,3):]",
        "[link(3,3):shortcut:/url:title::::foo:False::::]",
        "[text(3,4):foo:]",
        "[end-link::]",
        "[end-para:::True]",
        "[end-block-quote:::True]",
...
> [foo]"""
    expected_tokens = [
        ...
        "[BLANK(3,2):]",
        "[para(4,3):]",
        "[link(4,3):shortcut:/url:title::::foo:False::::]",
        "[text(4,4):foo:]",
        "[end-link::]",
        "[end-para:::True]",
        "[end-block-quote:::True]",
...
> [foo]"""
    expected_tokens = [
        ...
        "[BLANK(4,2):]",
        "[para(5,3):]",
        "[link(5,3):shortcut:/url:title::::foo:False::::]",
        "[text(5,4):foo:]",
        "[end-link::]",
        "[end-para:::True]",
        "[end-block-quote:::True]",
...
> [foo]"""
    expected_tokens = [
        ...
        '[link-ref-def(1,3):True::foo:: :/url:: :title:"title":]',
        "[para(2,3):]",
        "[link(2,3):shortcut:/url:title::::foo:False::::]",
        "[text(2,4):foo:]",
        "[end-link::]",
        "[end-para:::True]",
        "[end-block-quote:::True]",
...
> [Foo bar]"""
    expected_tokens = [
        ...
        "[BLANK(4,2):]",
        "[para(5,3):]",
        "[link(5,3):shortcut:my%20url:title::::Foo bar:False::::]",
        "[text(5,4):Foo bar:]",
        "[end-link::]",
        "[end-para:::True]",
        "[end-block-quote:::True]",
