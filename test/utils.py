...
def write_temporary_configuration(
    supplied_configuration, file_name=None, directory=None, file_name_prefix=None, file_name_suffix=None
):
    """
    ...
    try:
        if file_name:
            ...
            with tempfile.NamedTemporaryFile(
                "wt", delete=False, dir=directory, suffix=file_name_suffix, prefix=file_name_prefix
            ) as outfile:
                if isinstance(supplied_configuration, str):
                    outfile.write(supplied_configuration)
                else:
...
def create_temporary_configuration_file(
    supplied_configuration, file_name=None, directory=None, file_name_suffix=None, file_name_prefix=None
):
    """
    ...
    try:
        temp_source_path = write_temporary_configuration(
            supplied_configuration, file_name=file_name, directory=directory, file_name_suffix=file_name_suffix,file_name_prefix=file_name_prefix
        )
        yield temp_source_path
    finally:
