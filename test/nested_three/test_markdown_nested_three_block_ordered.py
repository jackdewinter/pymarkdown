...
def test_nested_three_block_max_ordered_max_unordered_max_with_li2():
    ...
    source_markdown = """   >    1.    + list
   >          + item"""
    expected_tokens = ['[block-quote(1,4):   :   > \n   > ]', '[olist(1,9):.:1:14:   ]', '[ulist(1,15):+::16:         ]', '[para(1,17):]', '[text(1,17):list:]', '[end-para:::True]', '[li(2,15):16:         :]', '[para(2,17):]', '[text(2,17):item:]', '[end-para:::True]', '[end-ulist:::True]', '[end-olist:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<ul>
...
def test_nested_three_block_max_ordered_max_unordered_max_with_li3():
    ...
    source_markdown = """   >    1.    + list
   >    1.    + item"""
    expected_tokens = ['[block-quote(1,4):   :   > \n   > ]', '[olist(1,9):.:1:14:   ]', '[ulist(1,15):+::16:         ]', '[para(1,17):]', '[text(1,17):list:]', '[end-para:::True]', '[end-ulist:::True]', '[li(2,9):14:   :1]', '[ulist(2,15):+::16:         ]', '[para(2,17):]', '[text(2,17):item:]', '[end-para:::True]', '[end-ulist:::True]', '[end-olist:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<ul>
...
def test_nested_three_block_max_ordered_max_unordered_max_empty_with_li1():
    ...
    source_markdown = """   >    1.    +
   >    1.      item"""
    expected_tokens = ['[block-quote(1,4):   :   > \n   > \n\n]', '[olist(1,9):.:1:14:   ]', '[ulist(1,15):+::16:         ]', '[BLANK(1,16):]', '[end-ulist:::True]', '[end-olist:::True]', '[icode-block(2,5):    :\n    ]', '[text(2,5):1.      item\n    1.      item:    ]', '[end-icode-block:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<ul>
...
def test_nested_three_block_max_ordered_max_unordered_max_empty_with_li2():
    ...
    source_markdown = """   >    1.    +
   >          + item"""
    expected_tokens = ['[block-quote(1,4):   :   > \n   > ]', '[olist(1,9):.:1:14:   ]', '[ulist(1,15):+::16:         ]', '[BLANK(1,16):]', '[li(2,15):16:         :]', '[para(2,17):]', '[text(2,17):item:]', '[end-para:::True]', '[end-ulist:::True]', '[end-olist:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<ul>
...
def test_nested_three_block_max_ordered_max_unordered_max_empty_no_bq1_with_li1():
    ...
    source_markdown = """   >    1.    +
        1.      item"""
    expected_tokens = ['[block-quote(1,4):   :   > ]', '[olist(1,9):.:1:14:   ]', '[ulist(1,15):+::16:         ]', '[BLANK(1,16):]', '[end-ulist:::False]', '[end-olist:::False]', '[end-block-quote:::False]', '[icode-block(2,5):    :]', '[text(2,5):1.      item:    ]', '[end-icode-block:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<ul>
...
def test_nested_three_block_max_ordered_max_unordered_max_empty_no_bq1_with_li2():
    ...
    source_markdown = """   >    1.    +
              + item"""
    expected_tokens = ['[block-quote(1,4):   :   > ]', '[olist(1,9):.:1:14:   ]', '[ulist(1,15):+::16:         ]', '[BLANK(1,16):]', '[end-ulist:::False]', '[end-olist:::False]', '[end-block-quote:::False]', '[icode-block(2,5):    :]', '[text(2,5):+ item:          ]', '[end-icode-block:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<ul>
...
def test_nested_three_block_max_ordered_max_ordered_max_with_li1():
    ...
    source_markdown = """   >    1.    1. list
   >    1.       item"""
    expected_tokens = ['[block-quote(1,4):   :   > \n   > ]', '[olist(1,9):.:1:14:   ]', '[olist(1,15):.:1:17:         ]', '[para(1,18):]', '[text(1,18):list:]', '[end-para:::True]', '[end-olist:::True]', '[li(2,9):11:   :1]', '[icode-block(2,16):    :]', '[text(2,16):item:  ]', '[end-icode-block:::True]', '[end-olist:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<ol>
...
def test_nested_three_block_max_ordered_max_ordered_max_with_li2():
    ...
    source_markdown = """   >    1.    1. list
   >          1. item"""
    expected_tokens =  ['[block-quote(1,4):   :   > \n   > ]', '[olist(1,9):.:1:14:   ]', '[olist(1,15):.:1:17:         ]', '[para(1,18):]', '[text(1,18):list:]', '[end-para:::True]', '[li(2,15):17:         :1]', '[para(2,18):]', '[text(2,18):item:]', '[end-para:::True]', '[end-olist:::True]', '[end-olist:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<ol>
...
def test_nested_three_block_max_ordered_max_ordered_max_with_li3():
    ...
    source_markdown = """   >    1.    1. list
   >    1.    1. item"""
    expected_tokens = ['[block-quote(1,4):   :   > \n   > ]', '[olist(1,9):.:1:14:   ]', '[olist(1,15):.:1:17:         ]', '[para(1,18):]', '[text(1,18):list:]', '[end-para:::True]', '[end-olist:::True]', '[li(2,9):14:   :1]', '[olist(2,15):.:1:17:         ]', '[para(2,18):]', '[text(2,18):item:]', '[end-para:::True]', '[end-olist:::True]', '[end-olist:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<ol>
...
def test_nested_three_block_max_ordered_max_ordered_max_empty_with_li1():
    ...
    source_markdown = """   >    1.    1.
   >    1.       item"""
    expected_tokens = ['[block-quote(1,4):   :   > \n   > \n\n]', '[olist(1,9):.:1:14:   ]', '[olist(1,15):.:1:17:         ]', '[BLANK(1,17):]', '[end-olist:::True]', '[end-olist:::True]', '[icode-block(2,5):    :\n    ]', '[text(2,5):1.       item\n    1.       item:    ]', '[end-icode-block:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<ol>
...
def test_nested_three_block_max_ordered_max_ordered_max_empty_with_li2():
    ...
    source_markdown = """   >    1.    1.
   >          1. item"""
    expected_tokens = ['[block-quote(1,4):   :   > \n   > ]', '[olist(1,9):.:1:14:   ]', '[olist(1,15):.:1:17:         ]', '[BLANK(1,17):]', '[li(2,15):17:         :1]', '[para(2,18):]', '[text(2,18):item:]', '[end-para:::True]', '[end-olist:::True]', '[end-olist:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<ol>
...
def test_nested_three_block_max_ordered_max_ordered_max_empty_with_li3():
    ...
    source_markdown = """   >    1.    1.
   >    1.    1. item"""
    expected_tokens = ['[block-quote(1,4):   :   > \n   > \n\n]', '[olist(1,9):.:1:14:   ]', '[olist(1,15):.:1:17:         ]', '[BLANK(1,17):]', '[end-olist:::True]', '[end-olist:::True]', '[icode-block(2,5):    :\n    ]', '[text(2,5):1.    1. item\n    1.    1. item:    ]', '[end-icode-block:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<ol>
...
def test_nested_three_block_max_ordered_max_ordered_max_empty_no_bq1_with_li1():
    ...
    source_markdown = """   >    1.    1.
        1.       item"""
    expected_tokens = ['[block-quote(1,4):   :   > ]', '[olist(1,9):.:1:14:   ]', '[olist(1,15):.:1:17:         ]', '[BLANK(1,17):]', '[end-olist:::False]', '[end-olist:::False]', '[end-block-quote:::False]', '[icode-block(2,5):    :]', '[text(2,5):1.       item:    ]', '[end-icode-block:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<ol>
...
def test_nested_three_block_max_ordered_max_ordered_max_empty_no_bq1_with_li3():
    ...
    source_markdown = """   >    1.    1.
        1.    1. item"""
    expected_tokens = ['[block-quote(1,4):   :   > ]', '[olist(1,9):.:1:14:   ]', '[olist(1,15):.:1:17:         ]', '[BLANK(1,17):]', '[end-olist:::False]', '[end-olist:::False]', '[end-block-quote:::False]', '[icode-block(2,5):    :]', '[text(2,5):1.    1. item:    ]', '[end-icode-block:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<ol>
...
def test_nested_three_block_max_ordered_max_block_max_with_li():
    ...
    source_markdown = """   >    1.    > list
   >    1.    > item"""
    expected_tokens = ['[block-quote(1,4):   :   > ]', '[olist(1,9):.:1:14:   :]', '[block-quote(1,15)::> \n   > ]', '[para(1,17):]', '[text(1,17):list:]', '[end-para:::True]', '[end-block-quote:::True]', '[li(2,9):14:   :1]', '[block-quote(2,15)::> ]', '[para(2,17):]', '[text(2,17):item:]', '[end-para:::True]', '[end-block-quote:::True]', '[end-olist:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<blockquote>
...
def test_nested_three_block_max_ordered_max_block_max_empty_with_li():
    ...
    source_markdown = """   >    1.    >
   >    1.    > item"""
    expected_tokens = ['[block-quote(1,4):   :   > \n   > \n\n]', '[olist(1,9):.:1:14:   ]', '[block-quote(1,15)::>]', '[BLANK(1,16):]', '[end-block-quote:::True]', '[end-olist:::True]', '[icode-block(2,5):    :\n    ]', '[text(2,5):1.    \a>\a&gt;\a item\n    1.    \a>\a&gt;\a item:    ]', '[end-icode-block:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<blockquote>
...
def test_nested_three_block_max_ordered_max_block_max_no_bq1_wih_li():
    ...
    source_markdown = """   >    1.    > list
        1.    > item"""
    expected_tokens = ['[block-quote(1,4):   :   > ]', '[olist(1,9):.:1:14:   :]', '[block-quote(1,15)::> \n]', '[para(1,17):\n        ]', '[text(1,17):list\n1.    \a>\a&gt;\a item::\n]', '[end-para:::True]', '[end-block-quote:::True]', '[end-olist:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<blockquote>
...
def test_nested_three_block_max_ordered_max_block_max_empty_no_bq1_with_li():
    ...
    source_markdown = """   >    1.    >
        1.    > item"""
    expected_tokens = ['[block-quote(1,4):   :   > ]', '[olist(1,9):.:1:14:   ]', '[block-quote(1,15)::>]', '[BLANK(1,16):]', '[end-block-quote:::False]', '[end-olist:::False]', '[end-block-quote:::False]', '[icode-block(2,5):    :]', '[text(2,5):1.    \a>\a&gt;\a item:    ]', '[end-icode-block:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<blockquote>
...
def test_nested_three_block_max_ordered_max_block_max_no_bq2_with_li():
    ...
    source_markdown = """   >    1.    > list
   >    1.      item"""
    expected_tokens =  ['[block-quote(1,4):   :   > ]', '[olist(1,9):.:1:14:   ]', '[block-quote(1,15)::> \n   > ]', '[para(1,17):]', '[text(1,17):list:]', '[end-para:::True]', '[end-block-quote:::True]', '[li(2,9):11:   :1]', '[icode-block(2,16):    :]', '[text(2,16):item: ]', '[end-icode-block:::True]', '[end-olist:::True]', '[end-block-quote:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<blockquote>
...
def test_nested_three_block_max_ordered_max_block_max_empty_no_bq3_with_li():
    ...
    source_markdown = """   >    1.    >
        1.      item"""
    expected_tokens = ['[block-quote(1,4):   :   > ]', '[olist(1,9):.:1:14:   ]', '[block-quote(1,15)::>]', '[BLANK(1,16):]', '[end-block-quote:::False]', '[end-olist:::False]', '[end-block-quote:::False]', '[icode-block(2,5):    :]', '[text(2,5):1.      item:    ]', '[end-icode-block:::True]']
    expected_gfm = """<blockquote>
<ol>
<li>
<blockquote>
